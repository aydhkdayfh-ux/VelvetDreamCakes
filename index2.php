...
<head>
	<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-QVV78QD8R9"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-QVV78QD8R9');
</script>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>VelvetDreamCakes· luxury wedding cakes</title>
...
<body>
  ...
  <header class="header" id="home">
    <div class="container header-inner">
      <a href="#" class="logo">VelvetDream<span>Cakes</span></a>
  ...
  <section class="container">
    ...
    <div class="testimonial-grid">
      ...
      <div class="testimonial-card"><p>“Absolutely stunning. Every guest asked about the cake. VelvetDreamCakes made our dream cake real.”</p><p style="margin-top:1rem;font-weight:600;">— Sophie &amp; Daniel</p></div>
...
<section class="container privacy-box" id="privacy-policy">
  ...
  <footer class="footer">
    <div class="container footer-grid">
      <div><a href="#" class="logo" style="font-size:1.8rem;">VelvetDream<span>Cakes</span></a><p style="margin:0.5rem 0 0;color:#5b4640;">Luxury wedding cakes, handcrafted with love.</p></div>
    ...
    <div class="container footer-bottom">
      <span>&copy; 2026 VelvetDreamCakes. All rights reserved.</span>
